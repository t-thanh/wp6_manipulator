"""autogenerated by genpy from crops_wp6_arm_msgs/JointMovementActionResult.msg. Do not edit."""
import sys
...
class JointMovementActionResult(genpy.Message):
  ...
  _type = "crops_wp6_arm_msgs/JointMovementActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','crops_wp6_arm_msgs/JointMovementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = crops_wp6_arm_msgs.msg.JointMovementResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = crops_wp6_arm_msgs.msg.JointMovementResult()
