...
#include <crops_arm_tutorials/follow_joint_trajectory_client.h>

namespace crops_arm_tutorials
{

FollowJointTrajectoryClient::FollowJointTrajectoryClient() :
    traj_client_("/crops_arm_controller/follow_joint_trajectory", true), got_joint_state_(false), spinner_(1)
{
...
int main(int argc, char** argv)
{
  ...
  crops_arm_tutorials::FollowJointTrajectoryClient arm;
