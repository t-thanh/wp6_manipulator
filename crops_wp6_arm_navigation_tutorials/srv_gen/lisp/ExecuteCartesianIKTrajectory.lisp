...
(cl:in-package crops_wp6_arm_navigation_tutorials-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteCartesianIKTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteCartesianIKTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crops_wp6_arm_navigation_tutorials-srv:<ExecuteCartesianIKTrajectory-request> is deprecated: use crops_wp6_arm_navigation_tutorials-srv:ExecuteCartesianIKTrajectory-request instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ExecuteCartesianIKTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crops_wp6_arm_navigation_tutorials-srv:header-val is deprecated.  Use crops_wp6_arm_navigation_tutorials-srv:header instead.")
  (header m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <ExecuteCartesianIKTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crops_wp6_arm_navigation_tutorials-srv:poses-val is deprecated.  Use crops_wp6_arm_navigation_tutorials-srv:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExecuteCartesianIKTrajectory-request>)))
  ...
  "crops_wp6_arm_navigation_tutorials/ExecuteCartesianIKTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory-request)))
  "Returns string type for a service object of type 'ExecuteCartesianIKTrajectory-request"
  "crops_wp6_arm_navigation_tutorials/ExecuteCartesianIKTrajectoryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteCartesianIKTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteCartesianIKTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crops_wp6_arm_navigation_tutorials-srv:<ExecuteCartesianIKTrajectory-response> is deprecated: use crops_wp6_arm_navigation_tutorials-srv:ExecuteCartesianIKTrajectory-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ExecuteCartesianIKTrajectory-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crops_wp6_arm_navigation_tutorials-srv:success-val is deprecated.  Use crops_wp6_arm_navigation_tutorials-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExecuteCartesianIKTrajectory-response>)))
  ...
  "crops_wp6_arm_navigation_tutorials/ExecuteCartesianIKTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory-response)))
  "Returns string type for a service object of type 'ExecuteCartesianIKTrajectory-response"
  "crops_wp6_arm_navigation_tutorials/ExecuteCartesianIKTrajectoryResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory)))
  ...
  "crops_wp6_arm_navigation_tutorials/ExecuteCartesianIKTrajectory")