...
int main(int argc, char **argv){
  ...
  ros::service::waitForService("crops_wp6_arm_kinematics/get_ik");
  ...
  ros::ServiceClient ik_client = rh.serviceClient<kinematics_msgs::GetPositionIK>("crops_wp6_arm_kinematics/get_ik");
  ...
  gpik_req.ik_request.pose_stamped.pose.position.x = 0.00;
  gpik_req.ik_request.pose_stamped.pose.position.y = 0.9;
