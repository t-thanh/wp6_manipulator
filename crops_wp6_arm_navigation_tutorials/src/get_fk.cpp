...
int main(int argc, char **argv){
  ...
  ros::service::waitForService("crops_wp6_arm_kinematics/get_fk_solver_info");
  ros::service::waitForService("crops_wp6_arm_kinematics/get_fk");

  ros::ServiceClient query_client = 
    rh.serviceClient<kinematics_msgs::GetKinematicSolverInfo>
    ("crops_wp6_arm_kinematics/get_fk_solver_info");
  ros::ServiceClient fk_client = rh.serviceClient
    <kinematics_msgs::GetPositionFK>("crops_wp6_arm_kinematics/get_fk");
  ...
  fk_request.fk_link_names[0] = "body9";
  fk_request.fk_link_names[1] = "body4";
